...
let cuteness = "Infinity + ";
console.log(cuteness + pet);
...
console.log(`My ${pet} cat is cuteness level of ${cuteness}.`);
...
// Unicode stands for Universal Coded Character. Unicode provides a unique number for every character and is universal across devices and langauges.
...
console.log("Yao".concat(" ", "Jiang"));

// Create a string and make it return true using startsWith()

console.log("Hello, my name is Yao.".startsWith("Hello"));

// Now use any variable with endsWith() and return false

console.log("Hello, my name is Yao.".endsWith("James."));

// Finish the following sentence. Use includes() and return true.

const ozgur =
  "Once upon a time Ozgur looked up at the Moon, and it was very bright.";
...
console.log(joshIsLookingForWifey.length);
const regex = /[a-z]/;
...
const extraSpace = "     5 spaces on both sides     ";
...
for (i = 0; i < 10; i++) {
  console.log("My room is spinning!");
}

// Harry said that was so mean of Teo to do Ken dirty like that. Make Teo's vision spin 20 times FOR LOOP.

for (i = 0; i < 20; i++) {
  console.log("Teo is sorry!");
}
...
// push() // Adds one or more element to the end of the array and returns the length of new array
// pop()  //Removes the last element of an array and returns that element
// unshift() //Adds one or more element to the beginning of the array and returns the length of the new array
// shift() //Removes the first element of an array and returns the removed element
// concat() //Return a new array of two or more merged arrays
// splice() //Changes the original array by adding, removing, or replacing elements
// slice() //Returns a copy of a portion of the array(or sometimes the whole array)
// sort() //Will sort the array in place by converting the characters of the individual elements into UTF-16 codes
// includes() //Will return true or false based on whether the array includes a certain element
// indexOf()  //Returns the first index of an array in which the element can be found. Will return -1 if the element is not found
...
let exoticFruits = ["Dragon Fruit", "Durian", "Passion Fruit"];
let fruitPlatter = fruits.concat(exoticFruits);
console.log(fruitPlatter);

// Print the last two exotic fruits without altering the newly concatenated array.

console.log(fruitPlatter.slice(-2));
...
console.log(
  numbersToAddUp.reduce((previous, current) => previous + current, 0)
);
...
myString(`Don't play with me haha.`);
...
let Yao = function () {
  console.log("Yao" + " " + "Jiang");
};
Yao();

// Create an arrow function that accepts a number and have it return that number doubled

let doubled = (num) => console.log(num * 2);
doubled(3);
...
for (prop in bulbasaur) {
  propOfBulba.push(prop);
}
console.log(propOfBulba);
...
let valuesOfBulba = [];
for (prop in bulbasaur) {
  valuesOfBulba.push(bulbasaur[prop]);
}
console.log(valuesOfBulba);
